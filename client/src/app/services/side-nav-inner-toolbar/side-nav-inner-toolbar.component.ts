...
import { SideNavigationMenuModule } from '../shared/side-navigation-menu/side-navigation-menu.component';
...
@Component({
  ...
  providers: [ScreenService]  // Provide the service here if not using 'root'
