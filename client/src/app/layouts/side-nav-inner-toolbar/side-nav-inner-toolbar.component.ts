...
import { ScreenService } from '../../services/shared';
...
@Component({
    ...
    standalone: true,
    imports: [DxDrawerModule, DxTemplateModule, SideNavigationMenuComponent, DxToolbarModule, NgIf, DxiItemModule, HeaderComponent, DxScrollViewModule]
})
