...
namespace API.Migrations
{
    ...
    [Migration("20240927154147_Reportsandotherstuff")]
    partial class Reportsandotherstuff
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.Domain.Questions.Question", b =>
                {
                    ...
                    b.HasDiscriminator<string>("QuestionType").HasValue("Basic");

                    b.UseTphMappingStrategy();
                });

            modelBuilder.Entity("API.Models.Domain.Reports.QuestionAssessment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Models.Domain.Reports.Report", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Models.Domain.Answer", b =>
                {
                    b.HasOne("API.Models.Domain.Questions.Question", "Question")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("API.Models.Domain.Reports.QuestionAssessment", b =>
                {
                    ...
                    b.HasOne("API.Models.Domain.Reports.Report", "Report")
                        .WithMany("QuestionAssessments")
            ...
            modelBuilder.Entity("API.Models.Domain.Reports.Report", b =>
                {
                    b.HasOne("API.Models.Domain.Extra.Test", "Test")
                        .WithOne("Report")
                        .HasForeignKey("API.Models.Domain.Reports.Report", "TestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("API.Models.Domain.Questions.Question", b =>
                {
                    ...
                    b.Navigation("QuestionAssessments");
                });
